"""
Physical Engines for MirnanNew — Modularized rebuild with 10 groups.
Phase 4 Refactoring.
"""
...
# ═══════════════════════════════════════════════════════
# Groups (Tightly organized in correct dependency order)
# ═══════════════════════════════════════════════════════
include("groups/core_group.jl")
include("groups/basic_physics_group.jl")
include("groups/quantum_group.jl")
include("groups/memory_group.jl")
include("groups/morphology_group.jl")
include("groups/arabic_group.jl")
include("groups/wave_group.jl")
include("groups/infra_group.jl")      # Loaded before generation/prnn
include("groups/prnn_group.jl")       # Loaded before generation

# ═══════════════════════════════════════════════════════
# Al-Aql (Kept standalone for its massive size, loaded before generator)
# ═══════════════════════════════════════════════════════
include("al_aql/al_aql.jl")

include("groups/generation_group.jl") # Loaded last, depends on AlAql

using .AlAql: AqlEntity, Thing, Lion, Gazelle, Earth, Furniture,
...
using .RAPGModule: RAPGKnowledgeBase, init_rapg_db!, store_passage!, load_rapg_kb, retrieve
...
export RAPGKnowledgeBase, init_rapg_db!, store_passage!, load_rapg_kb, retrieve
